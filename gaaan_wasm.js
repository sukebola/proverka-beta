...
function _WebMonetization_PlatformIsMonetized() {
...
function _WebMonetization_PlatformSetEventListener(listener) {
  Context.listener = listener;
  if (document.monetization === undefined) {
    return;
  }
  document.monetization.addEventListener("", function (event) {
    getWasmTableEntry(Context.listener)(stringToUTF8OnStack("monetizationpending"), stringToUTF8OnStack(JSON.stringify(event.detail !== undefined ? event.detail : {})));
  });
  document.monetization.addEventListener("monetizationstart", function (event) {
    getWasmTableEntry(Context.listener)(stringToUTF8OnStack("monetizationstart"), stringToUTF8OnStack(JSON.stringify(event.detail !== undefined ? event.detail : {})));
  });
  document.monetization.addEventListener("monetizationprogress", function (event) {
    getWasmTableEntry(Context.listener)(stringToUTF8OnStack("monetizationprogress"), stringToUTF8OnStack(JSON.stringify(event.detail !== undefined ? event.detail : {})));
  });
  document.monetization.addEventListener("monetizationstop", function (event) {
    getWasmTableEntry(Context.listener)(stringToUTF8OnStack("monetizationstop"), stringToUTF8OnStack(JSON.stringify(event.detail !== undefined ? event.detail : {})));
  });
}
...
var wasmImports = {
  Mh: _WebMonetization_PlatformIsMonetized,
  Lh: _WebMonetization_PlatformSetEventListener,
  b: ___assert_fail,
